<template>
  ...
  <div class="travel-container">
    <div class="travel-header section">
      ...
      <p> Stay tuned, travel information will be released in August! </p>
      <!-- <h4>Technica provides buses or reimbursements for travel fees</h4>
      <p class="process-blurb">
        <b
          >The Technica opening ceremony will start at 12:00pm EST on Saturday,
          October 21 and the closing ceremony will be at 3:00pm EST on Sunday,
          October 22.</b
        >
        Eligible hackers who need transportation to Technica will receive more
        information on how to apply for bus seats and travel reimbursements
        after registering to attend Technica in person. Your eligibility is
        determined by your location from your registration form responses and is
        only applicable for hackers in the United States. Please read below for
        more details and to check your eligibility for either option.
        <b
          >Note: For questions about travel and hotel registration please
          contact us at travel@gotechnica.org and not at The Hotel UNLESS you
          are booking a hotel room yourselves without Technica reimbursement!</b
        >
      </p> -->
    </div>
    <!-- <div class="container">
      <div class="row row-cols-1 row-cols-md-2 section">
        <div class="info-section">
          ...
          <p>
            ...
            bus transportation. Buses will stop at Towson University, University
            of Maryland Baltimore County, Johns Hopkins University, Stevens
            Institute of Technology, New Jersey Institute of Technology, Rutgers
            University, Princeton University, University of Pennsylvania, and
            University of Delaware. Exact locations and departure times will be
            confirmed closer to the event. If we are not providing a bus to a
            city within 30 minutes of you and you are not within 30 minutes of
            College Park, Maryland, you may apply for travel reimbursement. A
            seperate form for hotel rooms will be sent out.
          </p>
        </div>
        <div class="info-section">
          <h3>Reimbursement</h3>
