  ...
  <div class="container">
    ...
    <div class="sponsor-letter">
      ...
      <p>Listed below are our available sponsorship tiers. Please contact us if you are interested in becoming a part of
        ...
        state that Technica has 501(c)(3) status. We look forward to hearing from you!</p>
      <br>
      <h5>Thank you,</h5>
    ...
    <!-- QUICK STATISTICS BUT FOR MOBILE -->
    ...
    <!-- Hacker Demographics -->
    <Header>Hacker Demographics</Header>
    ...
    <!-- TECHNICA SPONSOR BENEFITS -->
    <div class="prospectus-temp">
      <Header>Sponsorship Prospectus</Header>
      <p><span class="eg" data-toggle="tooltip" title="just like that!">&#9432;</span>
        &ensp; hover over for more information</p>
    </div>
        ...
        <table class="table table-hover separate"  style="margin-bottom: 0;">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="align-middle">
                <div class="general-text text-center">Virtual<br>Booth</div>
              </td>
            </tr>
            <tr>
              <td>
                Prize Categories <span data-toggle="tooltip"
            ...
            <tr>
              <td>
                Tech talk /<br>Workshop <span data-toggle="tooltip"
            ...
            <tr>
              <td>
                Recruiters at In-person & Virtual Event <span data-toggle="tooltip"
            ...
            <tr>
              <td>
                Private Interview/<br>Recruiting Room <span data-toggle="tooltip"
            ...
            <tr>
              <td>
                Pre-event Email<br>to Participants <span data-toggle="tooltip"
            ...
            <tr>
              <td>
                Distribution of<br>Marketing Materials <span data-toggle="tooltip"
...
html, body {
  background-image: linear-gradient(#6D4389, #6D4389);
}
...
.stat-text-horizontal h2,
p,
.stat-text-vertical h2,
p {
  margin: 0;
  padding: 0;
}
